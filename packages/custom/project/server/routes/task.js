...
module.exports=function(Task, app, auth, database) {
	...
	app.route('/projects/:projec_id/phases/:phase_id/tasks/:task_id/complete').put(task.complete);
	//app.route('/projects/:project_id/phases/:phase_id/tasks/:task_id').put(task.assign);
	app.route('projects/:project_id/phases/:phase_id/tasks/:task_id').post(task.complete);
